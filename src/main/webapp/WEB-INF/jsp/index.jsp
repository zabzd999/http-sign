...
<body>
<input type="button"  id="click" onclick="getsign('8s9fsfsf')" value="单击"/>
<input type="text"  id="sign"  />
<input type="text"  id="signStr"  />
<body>
</html>
...
<script type="text/javascript">
                ...
                l = function(t, n) {
                    if (! (t in u)) {
                        ...
                        if (n) {
                            ...
                            "onload" in i ? i.onload = a: i.onreadystatechange = function() { ("loaded" === this.readyState || "complete" === this.readyState) && a()
                                }
                        }
    ...
    function getsign( id){
        ...
        signc = dycs.sign(id)
        document.getElementById('sign').value=signc;
       document.getElementById('signStr').value='<%=request.getAttribute("signStr")%>';

        return signc;
    }


    getsign('<%=request.getAttribute("signStr")%>')
    //getsign("75874367592")
    //document.write(getsign("75874367592"));
</script>